...
class GridTrading:
    ...
    def display_grid_setup(self, verbose=True):
        if verbose:
            print("\nGrid Levels:")
            print("-" * 70)
            print(
    ...
    def execute_buy_order(self, current_price, verbose=False):
        executed_orders = []
    ...
    def execute_sell_order(self, current_price, profit_target_pct=3.4, verbose=False):
        executed_orders = []
